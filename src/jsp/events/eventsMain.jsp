                                ...
                                <tr valign="top">
                                    <td>
                                        ...
                                        <appbio:userInRole role="ADMIN, STAFF">
                                            <p>
                                                <a href="eventEdit.do?id=${event.id}"><img src="images/edit.gif" title="<spring:message code="button.edit"/>"/>&nbsp;<spring:message code="button.edit"/></a>
                                            </p>

                                            <p>
                                                <a href="eventDelete.do?id=${event.id}&back=events.do&type=event" onclick="return confirm('<spring:message code="event.delete.confirmation"/>');"><img src="images/trash.gif" title="<spring:message code="button.delete"/>"/>&nbsp;<spring:message code="button.delete"/></a>
                                            </p>
