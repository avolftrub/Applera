...
<!---->
				...
				<li><a href="http://www.appliedbiosystems.ru/index.do" title="Главная">Главная</a></li>

<!---->
<!--PRODUCTS LINK-->
<!---->
				<li class="toplevel"><a href="http://www.appliedbiosystems.ru/products.do?catalogNumber=0" title="Каталог продукции">Каталог</a>
	...
	<!---->
					<div class="subMenu clear">
						<div class="left">
							...
							<div class="mleft">
								<ul>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=601803">Анализ микро-РНК</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=600644">Выделение и очистка РНК/ДНК</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=600734">Генотипирование</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=600799">Идентификация личности и криминалистика</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=601595">Клеточная биология</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=601224">Контроль качества и безопасность</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=600832">Масс-спектрометрия</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=602380">Микрочипы</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=603013">Модификации и мечение ДНК/РНК</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=601246">ПЦР в &#034;реальном времени&#034;</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=600961">ПЦР/ОТ-ПЦР</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=603885">Праймеры и зонды на заказ</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=602984">Рибонуклеазный анализ, Нозерн/Саузерн блот</a></li>
								</ul>
							</div>
							<div class="mright">
								<ul>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=60522">Секвенирование ДНК (капиллярный электрофорез)</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=601192">Секвенирование белков</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=600587">Синтез ДНК</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=601116">Синтез пептидов</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=602991">Системы для транскрипции и трансляции</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=600818">Управление информацией</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=600670">Флуоресцентная спектрофотометрия</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=600500">Хроматография</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=600674">Экспрессия генов</a></li>
									<li><a href="http://appliedbiosystems.ru/products.do?catalogNumber=602391">ми(si-)РНК/РНКi</a></li>
						...
						<div class="right" style="padding-right:8px; padding-left:8px;">
							...
							<ul>
							<li><a href="http://www3.appliedbiosystems.com/prod/SpecialOffers/index.htm?abhomepage=eur" target="_blank" title="">Специальные предложения и новая продукция</a></li>

							</ul>

							<h3>Продукция TaqMan&reg;</h3>
							<ul>
                                <li><a href="http://www4.appliedbiosystems.com/tools/workflow/workflow.php" target="_blank"><i>Silencer</i>&reg; siRNAs</a></li>
				                ...
				                <li> <a href="http://appliedbiosystems.ru/products.do?catalogNumber=601272">Проточные карты TaqMan® Arrays</a></li>
...
<!--APPLICATIONS LINK-->
<!---->
				<li class="toplevel"><a href="http://www3.appliedbiosystems.com/applicationstechnologies/index.htm"  target="_blank" title="Приложения и технологии">Приложения и технологии</a>
					...
					<div class="subMenu clear">
						<div class="left">
							...
							<div class="mleft">
								<ul>
									...
									<li class="subContent"><a href="http://marketing.appliedbiosystems.com/mk/get/PDK_LANDING" target="_blank" title=""><spring:message code="header.menu.applications.food"/></a></li>
						...
						<div class="right" style="padding-right:8px;">
							...
							<ul>
                                ...
                                <li><a href="http://www3.appliedbiosystems.com/applicationstechnologies/MassSpectrometry/index.htm" target="_blank" title=""><spring:message code="header.menu.technologies.mass.spectro"/></a></li>
...
<!--SUPPORT LINK-->
<!---->
				<li class="toplevel"><a href="http://www.appliedbiosystems.ru/support.do" title="Поддержка">Поддержка</a>
	<!---->
	<!--DROPDOWN FOR SUPPORT LINK-->
	<!---->
...
<!--LEARNING LINK-->
<!---->
				<li class="toplevel"><a style="cursor:default;" href="javascript:void(0);" title="Обучение и события">Обучение и события</a>
	<!---->
	...
	<!---->
					...
					<div class="clear subMenuAlt">
						...
						<ul>
							<li><a href="http://appliedbiosystems.com/service/training/" target="_blank">Обучение пользователей</a></li>
							<li><a href="http://www.appliedbiosystems.ru/events.do"  target="_blank" title="">Семинары и мероприятия</a></li>
							<li class="lastRow"><a href="http://events-na.appliedbiosystems.com/mk/submit/webinar_ard?_JS=T&rd=cm" target="_blank" title="">Веб-презентации</a></li>
                        </ul>
...
<!---->
    ...
    <div id="banner1"><a href="http://marketing.appliedbiosystems.com/mk/get/TAQMAN_ARRAY_HMP_MS_LANDING?utm_source=AB-EU-hp&utm_medium=banner&utm_campaign=Megaplex" target="_blank"><img src="images/banner1.jpg" width="730" height="296" border="0" /></a></div>
    ...
    <div id="banner3"><a href="http://marketing.appliedbiosystems.com/mk/get/QUANTDUO?tum_source=AB-EU-hpg&utm_medium=banner&utm_campaign=duoquant" target="_blank"><img src="images/banner3.jpg" width="730" height="296" border="0" /></a></div>
    ...
    <div id="banner5"><a href="https://products.appliedbiosystems.com/ab/en/US/adirect/ab?cmd=catNavigate2&catID=601560&utm_source=AB-EU-hpg&utm_medium=banner&utm_campaign=Salmonella" target="_blank"><img src="images/banner5.jpg" width="730" height="296" border="0" /></a></div>
	</div>
                        ...
                        <p>
                            ...
                            <tr>
                                ...
                                <td style="padding:6px;padding-top:0px; width: 120px;" valign="top" width="44%">
                                   ...
                                   <ul >
                                    <li><a href="http://www3.appliedbiosystems.com/AB_Home/applicationstechnologies/MassSpectrometry/index.htm" target="_blank"><spring:message code="tab.learn.featured.topics.solutions.mass.spectr"/></a></li>
                                    </ul>
                                </td>
